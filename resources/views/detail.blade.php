...
@section('content1')
    <main class="main">
        ...
        <section id="courses-course-details" class="courses-course-details section py-5">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row g-4">
                    <div class="col-lg-8">
                        <img src="{{ $job->company && $job->company->imagepath ? asset($job->company->imagepath) : asset('assets/img/default-company.png') }}"
                            class="img-fluid" alt="{{ $job->company->name ?? 'Company' }}">
                    ...
                    <div class="col-lg-4">
                        <div class="course-info d-flex justify-content-between align-items-center border-bottom py-2">
                            <h5>Company</h5>
                            <p class="mb-0"><a href="#"
                                    class="text-decoration-none fw-semibold">{{ $job->user->name }}</a></p>
                        </div>
                        <div class="course-info d-flex justify-content-between align-items-center border-bottom py-2">
                            <h5>Category</h5>
    ...
    <button type="submit" class="btn btn-green btn-lg px-5">Accept</button>
</form>
        </div>
    </main>
@endsection
